...
type ReportService interface {
	...
	GetReportInfo(ctx context.Context, in *common.IdDto, opts ...client.CallOption) (*common.Response, error)
...
func (c *reportService) GetReportInfo(ctx context.Context, in *common.IdDto, opts ...client.CallOption) (*common.Response, error) {
	req := c.c.NewRequest(c.name, "Report.GetReportInfo", in)
...
func (c *reportService) CompleteRecondition(ctx context.Context, in *common.IdDto, opts ...client.CallOption) (*common.Response, error) {
	req := c.c.NewRequest(c.name, "Report.CompleteRecondition", in)
	out := new(common.Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type ReportHandler interface {
	// 根据carId获取report的详细信息
	// 返回：common.Response -> Data = ReportInfoDto
	GetReportInfo(context.Context, *common.IdDto, *common.Response) error
	// 根据leadId获取report的damage信息
	// 返回：common.Response -> Data = common.PagedList {
	//                  List<Any> = List<ReportDamageCategoryDto>
	//              }
...
func RegisterReportHandler(s server.Server, hdlr ReportHandler, opts ...server.HandlerOption) error {
	type report interface {
		GetReportInfo(ctx context.Context, in *common.IdDto, out *common.Response) error
...
func (h *reportHandler) GetReportInfo(ctx context.Context, in *common.IdDto, out *common.Response) error {
	return h.ReportHandler.GetReportInfo(ctx, in, out)
}
