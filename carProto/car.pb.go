...
type CarTransferStoreList struct {
	...
	FromStoreId uint64       `protobuf:"varint,4,opt,name=fromStoreId,proto3" json:"fromStoreId,omitempty"`
	ToStoreId   uint64       `protobuf:"varint,5,opt,name=toStoreId,proto3" json:"toStoreId,omitempty"`
...
func (x *CarTransferStoreList) GetCarId() uint64 {
	if x != nil {
		return x.CarId
	}
	return 0
...
func (x *CarTransferStoreList) GetFromStoreId() uint64 {
	if x != nil {
...
func (x *CarTransferStoreList) GetToStoreId() uint64 {
	if x != nil {
		return x.ToStoreId
	}
	return 0
...
var file_carProto_car_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x6b, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72,
	0x6b, 0x22, 0xe6, 0x01, 0x0a, 0x14, 0x43, 0x61, 0x72, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	...
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x66, 0x72, 0x6f, 0x6d, 0x53, 0x74, 0x6f,
	0x72, 0x65, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x6f, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x49,
	0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x74, 0x6f, 0x53, 0x74, 0x6f, 0x72, 0x65,
	...
	0x04, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xf3, 0x01, 0x0a, 0x13, 0x43,
	...
	0x32, 0xbb, 0x09, 0x0a, 0x03, 0x43, 0x61, 0x72, 0x12, 0x26, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12,
