...
type CarDto struct {
	...
	HighlightTags string `protobuf:"bytes,435,opt,name=highlightTags,proto3" json:"highlightTags,omitempty"`
	// 卖价
...
func (x *CarDto) GetHighlightTags() string {
	if x != nil {
...
var file_carProto_car_proto_rawDesc = []byte{
	...
	0x67, 0x68, 0x74, 0x54, 0x61, 0x67, 0x73, 0x18, 0xb3, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d,
