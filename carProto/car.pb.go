...
// 车辆的no或lp
type CarNoAndLicensePlateDto struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CarNoAndLicensePlateDto) Reset() {
	*x = CarNoAndLicensePlateDto{}
	if protoimpl.UnsafeEnabled {
...
func (x *CarNoAndLicensePlateDto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CarNoAndLicensePlateDto) ProtoMessage() {}

func (x *CarNoAndLicensePlateDto) ProtoReflect() protoreflect.Message {
	mi := &file_carProto_car_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CarNoAndLicensePlateDto.ProtoReflect.Descriptor instead.
func (*CarNoAndLicensePlateDto) Descriptor() ([]byte, []int) {
	return file_carProto_car_proto_rawDescGZIP(), []int{18}
}

func (x *CarNoAndLicensePlateDto) GetCarNo() string {
	if x != nil {
		return x.CarNo
	}
	return ""
...
func (x *CarNoAndLicensePlateDto) GetLicensePlate() string {
	if x != nil {
		return x.LicensePlate
	}
	return ""
...
func (x *CarNoAndLicensePlateDto) GetLocal() string {
	if x != nil {
		return x.Local
	}
	return ""
...
var file_carProto_car_proto_rawDesc = []byte{
	...
	0x6c, 0x22, 0x69, 0x0a, 0x17, 0x43, 0x61, 0x72, 0x4e, 0x6f, 0x41, 0x6e, 0x64, 0x4c, 0x69, 0x63,
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x32, 0xba, 0x08, 0x0a,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x43, 0x61,
	0x72, 0x42, 0x79, 0x43, 0x61, 0x72, 0x4e, 0x6f, 0x41, 0x6e, 0x64, 0x4c, 0x69, 0x63, 0x65, 0x6e,
	0x73, 0x65, 0x50, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x1c, 0x2e, 0x63, 0x61, 0x72, 0x2e, 0x43, 0x61,
	0x72, 0x4e, 0x6f, 0x41, 0x6e, 0x64, 0x4c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x50, 0x6c, 0x61,
...
var file_carProto_car_proto_goTypes = []interface{}{
	...
	(*CarNoAndLicensePlateDto)(nil),          // 18: car.CarNoAndLicensePlateDto
...
var file_carProto_car_proto_depIdxs = []int32{
	...
	21, // 21: car.Car.LaunchCar:input_type -> common.IdDto
	...
	18, // 28: car.Car.GetCarByCarNoAndLicensePlate:input_type -> car.CarNoAndLicensePlateDto
	...
	22, // 46: car.Car.GetCarDetailAccessData:output_type -> common.Response
	22, // 47: car.Car.GetCarByCarNoAndLicensePlate:output_type -> common.Response
...
func file_carProto_car_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_carProto_car_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CarNoAndLicensePlateDto); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
