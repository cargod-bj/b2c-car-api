...
var file_carProto_car_proto_rawDesc = []byte{
	...
	0x32, 0xcc, 0x0a, 0x0a, 0x03, 0x43, 0x61, 0x72, 0x12, 0x26, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12,
...
var file_carProto_car_proto_depIdxs = []int32{
	...
	27, // 34: car.Car.Add:output_type -> common.Response
	27, // 35: car.Car.Delete:output_type -> common.Response
	27, // 36: car.Car.Update:output_type -> common.Response
	27, // 37: car.Car.Get:output_type -> common.Response
	27, // 38: car.Car.GetSimpleInfo:output_type -> common.Response
	27, // 39: car.Car.GetForWebsite:output_type -> common.Response
	27, // 40: car.Car.List:output_type -> common.Response
	27, // 41: car.Car.SourceList:output_type -> common.Response
	27, // 42: car.Car.AddFromSource:output_type -> common.Response
	27, // 43: car.Car.AddFromSourceList:output_type -> common.Response
	27, // 44: car.Car.AddPartnerCar:output_type -> common.Response
	27, // 45: car.Car.LaunchCar:output_type -> common.Response
	27, // 46: car.Car.GetValidState:output_type -> common.Response
	27, // 47: car.Car.ChangeCarState:output_type -> common.Response
	27, // 48: car.Car.ChangeInventoryStatus:output_type -> common.Response
	27, // 49: car.Car.GetCarByCarNo:output_type -> common.Response
	27, // 50: car.Car.GetCarByNoFuzzy:output_type -> common.Response
	27, // 51: car.Car.GetCarDetailAccessData:output_type -> common.Response
	27, // 52: car.Car.GetCarByCarNoOrLicensePlate:output_type -> common.Response
	27, // 53: car.Car.TransferStore:output_type -> common.Response
	27, // 54: car.Car.TransferStoreList:output_type -> common.Response
	27, // 55: car.Car.GetCarByLicensePlateFuzzy:output_type -> common.Response
	27, // 56: car.Car.GetCarByNextMaintenanceDate:output_type -> common.Response
