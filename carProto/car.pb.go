...
type CarTransferStoreList struct {
	...
	FromStoreId  uint32 `protobuf:"varint,5,opt,name=fromStoreId,proto3" json:"fromStoreId,omitempty"`
	ToStoreId    uint32 `protobuf:"varint,6,opt,name=toStoreId,proto3" json:"toStoreId,omitempty"`
	OperatorId   uint64 `protobuf:"varint,7,opt,name=operatorId,proto3" json:"operatorId,omitempty"`
	BeginTime    uint64 `protobuf:"varint,8,opt,name=beginTime,proto3" json:"beginTime,omitempty"`
...
func (x *CarTransferStoreList) GetPage() uint32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *CarTransferStoreList) GetPageSize() uint32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
var file_carProto_car_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x6b, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72,
	0x6b, 0x22, 0x98, 0x02, 0x0a, 0x14, 0x43, 0x61, 0x72, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	0x72, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61,
	...
	0x52, 0x08, 0x70, 0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x61,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x50,
	0x6c, 0x61, 0x74, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x66, 0x72, 0x6f, 0x6d, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x49, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x66, 0x72, 0x6f, 0x6d, 0x53,
	0x74, 0x6f, 0x72, 0x65, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x6f, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x49, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x74, 0x6f, 0x53, 0x74, 0x6f,
	...
	0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x62, 0x65, 0x67, 0x69, 0x6e, 0x54, 0x69,
	0x6d, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x32, 0xb8, 0x08, 0x0a,
...
var file_carProto_car_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_carProto_car_proto_goTypes = []interface{}{
	...
	(*common.Page)(nil),                      // 21: common.Page
	(*reportProto.ReportDamagePointDto)(nil), // 22: report.ReportDamagePointDto
	(*common.IdDto)(nil),                     // 23: common.IdDto
	(*common.Response)(nil),                  // 24: common.Response
}
var file_carProto_car_proto_depIdxs = []int32{
	21, // 0: car.SourceParams.page:type_name -> common.Page
	3,  // 1: car.AddFromSourceListParams.list:type_name -> car.AddFromSourceParams
	21, // 2: car.CarListParams.page:type_name -> common.Page
	...
	22, // 8: car.UpdateCarDto.points:type_name -> report.ReportDamagePointDto
	...
	23, // 21: car.Car.LaunchCar:input_type -> common.IdDto
	...
	18, // 28: car.Car.GetCarByCarNoOrLicensePlate:input_type -> car.CarNoOrLicensePlateDto
	24, // 29: car.Car.Add:output_type -> common.Response
	24, // 30: car.Car.Delete:output_type -> common.Response
	24, // 31: car.Car.Update:output_type -> common.Response
	24, // 32: car.Car.Get:output_type -> common.Response
	24, // 33: car.Car.GetSimpleInfo:output_type -> common.Response
	24, // 34: car.Car.GetForWebsite:output_type -> common.Response
	24, // 35: car.Car.List:output_type -> common.Response
	24, // 36: car.Car.SourceList:output_type -> common.Response
	24, // 37: car.Car.AddFromSource:output_type -> common.Response
	24, // 38: car.Car.AddFromSourceList:output_type -> common.Response
	24, // 39: car.Car.AddPartnerCar:output_type -> common.Response
	24, // 40: car.Car.LaunchCar:output_type -> common.Response
	24, // 41: car.Car.GetValidState:output_type -> common.Response
	24, // 42: car.Car.ChangeCarState:output_type -> common.Response
	24, // 43: car.Car.ChangeInventoryStatus:output_type -> common.Response
	24, // 44: car.Car.GetCarByCarNo:output_type -> common.Response
	24, // 45: car.Car.GetCarByNoFuzzy:output_type -> common.Response
	24, // 46: car.Car.GetCarDetailAccessData:output_type -> common.Response
	24, // 47: car.Car.GetCarByCarNoOrLicensePlate:output_type -> common.Response
