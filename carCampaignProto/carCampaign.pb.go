...
type CarCampaignDetail struct {
	...
	// 卡片折扣文字背景颜色
	CardDiscountWordsBackgroundColor string `protobuf:"bytes,24,opt,name=cardDiscountWordsBackgroundColor,proto3" json:"cardDiscountWordsBackgroundColor,omitempty"`
}
