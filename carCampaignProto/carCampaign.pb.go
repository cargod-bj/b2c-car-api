...
type CarCampaignReq struct {
	...
	// 活动详情
	Campaign *CarCampaignDetail `protobuf:"bytes,1,opt,name=campaign,proto3" json:"campaign"`
	// 活动车辆列表
	Cars []*CarCampaignCar `protobuf:"bytes,2,rep,name=cars,proto3" json:"cars"`
	// 执行当前操作的用户id
...
type ListCarCampaignReq struct {
	...
	// 开始时间：开始
	StartTimeStart uint64 `protobuf:"varint,3,opt,name=startTimeStart,proto3" json:"startTimeStart"`
	// 开始时间：结束
	StartTimeEnd uint64 `protobuf:"varint,4,opt,name=startTimeEnd,proto3" json:"startTimeEnd"`
	// 结束时间：开始
	EndTimeStart uint64 `protobuf:"varint,5,opt,name=endTimeStart,proto3" json:"endTimeStart"`
	// 结束时间：结束
	EndTimeEnd uint64 `protobuf:"varint,6,opt,name=endTimeEnd,proto3" json:"endTimeEnd"`
	// 创建时间：开始
	CreateTimeStart uint64 `protobuf:"varint,7,opt,name=createTimeStart,proto3" json:"createTimeStart"`
	// 创建时间：结束
	CreateTimeEnd uint64 `protobuf:"varint,8,opt,name=createTimeEnd,proto3" json:"createTimeEnd"`
	// 活动状态
	CampaignStatus uint32 `protobuf:"varint,9,opt,name=campaignStatus,proto3" json:"campaignStatus"`
	// 本地化类型
	Local string `protobuf:"bytes,100,opt,name=local,proto3" json:"local"`
	// 分页信息
...
type CheckImportCarsReq struct {
	...
	Cars     []*CheckImportCarsItemDto `protobuf:"bytes,1,rep,name=cars,proto3" json:"cars"`
	StoreIds []uint64                  `protobuf:"varint,2,rep,packed,name=storeIds,proto3" json:"storeIds"`
}
...
type CheckImportCarsItemDto struct {
	...
	// 导入车辆时指定的活动价格
	CampaignPrice string `protobuf:"bytes,3,opt,name=campaignPrice,proto3" json:"campaignPrice"`
}
...
type CarCampaignList struct {
	...
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name"`
	// 开始时间
	StartTime uint64 `protobuf:"varint,4,opt,name=startTime,proto3" json:"startTime"`
	// 结束时间
	EndTime uint64 `protobuf:"varint,5,opt,name=endTime,proto3" json:"endTime"`
	// 活动状态
	CampaignStatus uint32 `protobuf:"varint,6,opt,name=campaignStatus,proto3" json:"campaignStatus"`
	// 活动状态
	CampaignStatusName string `protobuf:"bytes,7,opt,name=campaignStatusName,proto3" json:"campaignStatusName"`
	// 活动创建人id
	CreatorId uint64 `protobuf:"varint,8,opt,name=creatorId,proto3" json:"creatorId"`
	// 创建时间
	CreateTime uint64 `protobuf:"varint,9,opt,name=createTime,proto3" json:"createTime"`
	// 车辆数
	CarsCount uint32 `protobuf:"varint,10,opt,name=carsCount,proto3" json:"carsCount"`
}
...
type CarCampaignLogList struct {
	...
	// 活动状态
	CampaignStatus uint32 `protobuf:"varint,5,opt,name=campaignStatus,proto3" json:"campaignStatus"`
	// 活动状态
	CampaignStatusName string `protobuf:"bytes,8,opt,name=campaignStatusName,proto3" json:"campaignStatusName"`
	// 车辆数
	CarsCount uint32 `protobuf:"varint,6,opt,name=carsCount,proto3" json:"carsCount"`
	// 创建时间
...
type CarCampaignDetailWithCars struct {
	...
	Detail *CarCampaignDetail      `protobuf:"bytes,1,opt,name=detail,proto3" json:"detail"`
	Cars   []*CarCampaignWithPrice `protobuf:"bytes,2,rep,name=cars,proto3" json:"cars"`
}
...
type CarCampaignDetail struct {
	...
	EndTime uint64 `protobuf:"varint,5,opt,name=endTime,proto3" json:"endTime"`
	// 活动tagid
	TagId uint64 `protobuf:"varint,6,opt,name=tagId,proto3" json:"tagId"`
	// 活动创建人id
	CreatorId uint64 `protobuf:"varint,7,opt,name=creatorId,proto3" json:"creatorId"`
	// 活动页面图片资源
	ResWebDetailPriceBar string `protobuf:"bytes,8,opt,name=resWebDetailPriceBar,proto3" json:"resWebDetailPriceBar"`
	// 活动页面图片资源
	ResWebListItemTag string `protobuf:"bytes,9,opt,name=resWebListItemTag,proto3" json:"resWebListItemTag"`
	// 活动页面图片资源
	ResWebFilterTagSelected string `protobuf:"bytes,10,opt,name=resWebFilterTagSelected,proto3" json:"resWebFilterTagSelected"`
	// 活动页面图片资源
	ResWebFilterTagUnselected string `protobuf:"bytes,11,opt,name=resWebFilterTagUnselected,proto3" json:"resWebFilterTagUnselected"`
	// 活动页面图片资源
	ResH5DetailPriceBar string `protobuf:"bytes,12,opt,name=resH5DetailPriceBar,proto3" json:"resH5DetailPriceBar"`
	// 活动页面图片资源
	ResH5ListItemTag string `protobuf:"bytes,13,opt,name=resH5ListItemTag,proto3" json:"resH5ListItemTag"`
	// 活动页面图片资源
	ResH5FilterTagSelected string `protobuf:"bytes,14,opt,name=resH5FilterTagSelected,proto3" json:"resH5FilterTagSelected"`
	// 活动页面图片资源
	ResH5FilterTagUnselected string `protobuf:"bytes,15,opt,name=resH5FilterTagUnselected,proto3" json:"resH5FilterTagUnselected"`
	// 活动是否有效：1有效，2无效
	ActiveStatus uint32 `protobuf:"varint,16,opt,name=activeStatus,proto3" json:"activeStatus"`
	// 活动页面图片资源
	ResWebBannerDetailPageRight string `protobuf:"bytes,17,opt,name=resWebBannerDetailPageRight,proto3" json:"resWebBannerDetailPageRight"`
	//banner左侧label背景颜色
	BannerBgColorLeftLabel string `protobuf:"bytes,18,opt,name=bannerBgColorLeftLabel,proto3" json:"bannerBgColorLeftLabel"`
	//banner右侧label背景颜色
	BannerBgColorRightLabel string `protobuf:"bytes,19,opt,name=bannerBgColorRightLabel,proto3" json:"bannerBgColorRightLabel"`
	//banner title 颜色
	BannerTitleColor string `protobuf:"bytes,20,opt,name=bannerTitleColor,proto3" json:"bannerTitleColor"`
	//banner date 颜色
	BannerDateColor string `protobuf:"bytes,21,opt,name=bannerDateColor,proto3" json:"bannerDateColor"`
	// 卡片折扣文字颜色
	CardDiscountWordsColor string `protobuf:"bytes,22,opt,name=cardDiscountWordsColor,proto3" json:"cardDiscountWordsColor"`
	// 卡片图片
	CardDiscountTag string `protobuf:"bytes,23,opt,name=cardDiscountTag,proto3" json:"cardDiscountTag"`
	// 卡片折扣文字背景颜色
	CardDiscountWordsBackgroundColor string `protobuf:"bytes,24,opt,name=cardDiscountWordsBackgroundColor,proto3" json:"cardDiscountWordsBackgroundColor"`
}
...
func (x *CarCampaignDetail) GetCardDiscountWordsBackgroundColor() string {
	if x != nil {
...
type CarCampaignCar struct {
	...
	// 活动价
	CampaignPrice string `protobuf:"bytes,2,opt,name=campaignPrice,proto3" json:"campaignPrice"`
}
...
type CarCampaignWithPrice struct {
	...
	// 活动车辆
	Car *carProto.CarDto `protobuf:"bytes,1,opt,name=car,proto3" json:"car"`
	// 活动价
	CampaignPrice string `protobuf:"bytes,2,opt,name=campaignPrice,proto3" json:"campaignPrice"`
}
...
type CarCampaignCond struct {
	...
	CarId uint64 `protobuf:"varint,1,opt,name=carId,proto3" json:"carId"`
	// campaign ID
	CampaignId uint64 `protobuf:"varint,2,opt,name=campaignId,proto3" json:"campaignId"`
}
...
type CheckImportCarsResp struct {
	...
	// 成功总数
	SuccessCount uint32 `protobuf:"varint,1,opt,name=successCount,proto3" json:"successCount"`
	// 失败总数
	FailedCount uint32 `protobuf:"varint,2,opt,name=failedCount,proto3" json:"failedCount"`
	// 具体结果
	List []*CheckImportCarsItem `protobuf:"bytes,3,rep,name=list,proto3" json:"list"`
}
...
type CheckImportCarsItem struct {
	...
	FailedReasonType uint32 `protobuf:"varint,4,opt,name=failedReasonType,proto3" json:"failedReasonType"`
	// 活动车辆
	Car *carProto.CarDto `protobuf:"bytes,5,opt,name=car,proto3" json:"car"`
	// 导入车辆时指定的活动价格
	CampaignPrice string `protobuf:"bytes,6,opt,name=campaignPrice,proto3" json:"campaignPrice"`
}
...
var file_carCampaignProto_carCampaign_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x04, 0x63, 0x61, 0x72, 0x73, 0x22, 0xab, 0x08, 0x0a, 0x11,
	...
	0x72, 0x64, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x61, 0x67, 0x12, 0x4a, 0x0a,
	...
	0x72, 0x18, 0x18, 0x20, 0x01, 0x28, 0x09, 0x52, 0x20, 0x63, 0x61, 0x72, 0x64, 0x44, 0x69, 0x73,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x57, 0x6f, 0x72, 0x64, 0x73, 0x42, 0x61, 0x63, 0x6b, 0x67, 0x72,
	0x6f, 0x75, 0x6e, 0x64, 0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x22, 0x4c, 0x0a, 0x0e, 0x43, 0x61, 0x72,
	...
	0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x9c, 0x01, 0x0a, 0x13, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x43, 0x61, 0x72, 0x73, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x14,
	0x0a, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x69,
	0x6e, 0x64, 0x65, 0x78, 0x12, 0x2a, 0x0a, 0x10, 0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x52, 0x65,
	0x61, 0x73, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10,
	0x66, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65,
	0x12, 0x1d, 0x0a, 0x03, 0x63, 0x61, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0b, 0x2e,
	...
	,
	...
	,
	...
	,
