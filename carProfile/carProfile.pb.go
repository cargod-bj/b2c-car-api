...
type CarProfileCond struct {
	...
	CarModel string `protobuf:"bytes,1,opt,name=carModel,proto3" json:"carModel,omitempty"`
}
...
type CarProfileResp struct {
	...
	BodyType     string `protobuf:"bytes,8,opt,name=bodyType,proto3" json:"bodyType,omitempty"`
	UniqueCode   string `protobuf:"bytes,9,opt,name=uniqueCode,proto3" json:"uniqueCode,omitempty"`
	Profile      string `protobuf:"bytes,10,opt,name=profile,proto3" json:"profile,omitempty"`
	TypicalId    int64  `protobuf:"varint,11,opt,name=typicalId,proto3" json:"typicalId,omitempty"`
