...
func (x *CarTagType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CarTagType) ProtoMessage() {}

func (x *CarTagType) ProtoReflect() protoreflect.Message {
	mi := &file_carTag_carTag_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CarTagType.ProtoReflect.Descriptor instead.
func (*CarTagType) Descriptor() ([]byte, []int) {
	return file_carTag_carTag_proto_rawDescGZIP(), []int{2}
}

func (x *CarTagType) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CarTagType) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CarTagTypes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CarTagTypes) ProtoMessage() {}

func (x *CarTagTypes) ProtoReflect() protoreflect.Message {
	mi := &file_carTag_carTag_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CarTagTypes.ProtoReflect.Descriptor instead.
func (*CarTagTypes) Descriptor() ([]byte, []int) {
	return file_carTag_carTag_proto_rawDescGZIP(), []int{3}
}

func (x *CarTagTypes) GetCarTagType() []*CarTagType {
	if x != nil {
		return x.CarTagType
	}
	return nil
...
func (x *CarTagsType) Reset() {
	*x = CarTagsType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_carTag_carTag_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CarTagsType) Descriptor() ([]byte, []int) {
	return file_carTag_carTag_proto_rawDescGZIP(), []int{4}
}
...
func (x *CarTagsTypes) Reset() {
	*x = CarTagsTypes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_carTag_carTag_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CarTagsTypes) Descriptor() ([]byte, []int) {
	return file_carTag_carTag_proto_rawDescGZIP(), []int{5}
}
...
var file_carTag_carTag_proto_rawDesc = []byte{
	...
	0x95, 0x01, 0x0a, 0x12, 0x43, 0x61, 0x72, 0x54, 0x61, 0x67, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x44, 0x74, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x74, 0x61, 0x67, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x74, 0x61, 0x67, 0x54, 0x79, 0x70,
	...
	,
	...
	0x43, 0x61, 0x72, 0x54, 0x61, 0x67, 0x73, 0x54, 0x79, 0x70, 0x65, 0x73, 0x12, 0x32, 0x0a, 0x0b,
	0x63, 0x61, 0x72, 0x54, 0x61, 0x67, 0x73, 0x54, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x63, 0x61, 0x72, 0x2e, 0x43, 0x61, 0x72, 0x54, 0x61, 0x67, 0x73, 0x54,
	0x79, 0x70, 0x65, 0x52, 0x0b, 0x63, 0x61, 0x72, 0x54, 0x61, 0x67, 0x73, 0x54, 0x79, 0x70, 0x65,
	0x32, 0xaf, 0x02, 0x0a, 0x06, 0x43, 0x61, 0x72, 0x54, 0x61, 0x67, 0x12, 0x29, 0x0a, 0x03, 0x41,
	0x64, 0x64, 0x12, 0x0e, 0x2e, 0x63, 0x61, 0x72, 0x2e, 0x43, 0x61, 0x72, 0x54, 0x61, 0x67, 0x44,
	...
	0x12, 0x17, 0x2e, 0x63, 0x61, 0x72, 0x2e, 0x43, 0x61, 0x72, 0x54, 0x61, 0x67, 0x43, 0x6f, 0x6e,
	...
	,
	...
	0x61, 0x72, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x61, 0x72, 0x54, 0x61, 0x67, 0x62, 0x06, 0x70,
...
var file_carTag_carTag_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_carTag_carTag_proto_goTypes = []interface{}{
	...
	(*CarTagType)(nil),         // 2: car.CarTagType
	(*CarTagTypes)(nil),        // 3: car.CarTagTypes
	(*CarTagsType)(nil),        // 4: car.CarTagsType
	(*CarTagsTypes)(nil),       // 5: car.CarTagsTypes
	(*common.Response)(nil),    // 6: common.Response
}
var file_carTag_carTag_proto_depIdxs = []int32{
	2, // 0: car.CarTagTypes.carTagType:type_name -> car.CarTagType
	4, // 1: car.CarTagsTypes.carTagsType:type_name -> car.CarTagsType
	0, // 2: car.CarTag.Add:input_type -> car.CarTagDto
	1, // 3: car.CarTag.Delete:input_type -> car.CarTagConditionDto
	0, // 4: car.CarTag.Update:input_type -> car.CarTagDto
	1, // 5: car.CarTag.List:input_type -> car.CarTagConditionDto
	2, // 6: car.CarTag.TagType:input_type -> car.CarTagType
	4, // 7: car.CarTag.TagsType:input_type -> car.CarTagsType
	6, // 8: car.CarTag.Add:output_type -> common.Response
	6, // 9: car.CarTag.Delete:output_type -> common.Response
	6, // 10: car.CarTag.Update:output_type -> common.Response
	6, // 11: car.CarTag.List:output_type -> common.Response
	6, // 12: car.CarTag.TagType:output_type -> common.Response
	6, // 13: car.CarTag.TagsType:output_type -> common.Response
...
func file_carTag_carTag_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_carTag_carTag_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_carTag_carTag_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
