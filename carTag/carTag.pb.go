...
type CarTagDto struct {
	...
	TagType    string `protobuf:"bytes,9,opt,name=tag_type,json=tagType,proto3" json:"tag_type,omitempty"`
}
...
func (x *CarTagDto) GetTagType() string {
	if x != nil {
		return x.TagType
	}
	return ""
...
type CarTagConditionDto struct {
	...
	TagType  string `protobuf:"bytes,7,opt,name=tag_type,json=tagType,proto3" json:"tag_type,omitempty"`
...
func (x *CarTagConditionDto) GetTagType() string {
	if x != nil {
		return x.TagType
	}
	return ""
...
func (x *CarTagConditionDto) GetUpdateBy() string {
	if x != nil {
		return x.UpdateBy
	}
	return ""
...
var file_carTag_carTag_proto_rawDesc = []byte{
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x61, 0x67, 0x54, 0x79, 0x70, 0x65, 0x22,
	0xe8, 0x01, 0x0a, 0x12, 0x43, 0x61, 0x72, 0x54, 0x61, 0x67, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74,
	...
	0x67, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x61,
	...
	0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x22, 0x31, 0x0a, 0x0b, 0x43, 0x61,
