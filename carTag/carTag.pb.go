...
type CarTagDto struct {
	...
	// 最后操作人 id
	UpdateBy uint64 `protobuf:"varint,9,opt,name=update_by,json=updateBy,proto3" json:"update_by,omitempty"`
}
...
func (x *CarTagDto) GetUpdateBy() uint64 {
	if x != nil {
		return x.UpdateBy
	}
	return 0
...
var file_carTag_carTag_proto_rawDesc = []byte{
	...
	0x09, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x79, 0x22,
