...
var file_car_car_proto_rawDesc = []byte{
	...
	0xd9, 0x01, 0x0a, 0x03, 0x43, 0x61, 0x72, 0x12, 0x26, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12, 0x0b,
...
var file_car_car_proto_depIdxs = []int32{
	...
	2, // 4: car.Car.List:input_type -> common.Page
	3, // 5: car.Car.Add:output_type -> common.Response
	3, // 6: car.Car.Delete:output_type -> common.Response
	3, // 7: car.Car.Update:output_type -> common.Response
	3, // 8: car.Car.Get:output_type -> common.Response
	3, // 9: car.Car.List:output_type -> common.Response
