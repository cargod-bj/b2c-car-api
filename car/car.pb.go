...
func (x *CarIdDto) GetLocal() string {
	if x != nil {
		return x.Local
	}
	return ""
...
var file_car_car_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x30, 0x0a, 0x08, 0x43, 0x61, 0x72, 0x49,
	0x64, 0x44, 0x74, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x32, 0xc8, 0x02, 0x0a, 0x03, 0x43,
...
var file_car_car_proto_depIdxs = []int32{
	...
	5, // 1: car.CarListParams.page:type_name -> common.Page
	3, // 2: car.Car.Add:input_type -> car.CarDto
	4, // 3: car.Car.Delete:input_type -> car.CarIdDto
	3, // 4: car.Car.Update:input_type -> car.CarDto
	4, // 5: car.Car.Get:input_type -> car.CarIdDto
	1, // 6: car.Car.List:input_type -> car.CarListParams
