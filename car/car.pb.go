...
type CarDto struct {
	...
	// dealerType
	DealerType uint64 `protobuf:"varint,704,opt,name=dealer_type,json=dealerType,proto3" json:"dealer_type,omitempty"`
	// dealerTypeName
	DealerTypeName uint64 `protobuf:"varint,705,opt,name=dealer_type_name,json=dealerTypeName,proto3" json:"dealer_type_name,omitempty"`
	// 整备渠道
...
func (x *CarDto) GetDealerType() uint64 {
	if x != nil {
		return x.DealerType
	}
	return 0
...
func (x *CarDto) GetDealerTypeName() uint64 {
	if x != nil {
...
var file_car_car_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x54, 0x79, 0x70, 0x65, 0x22, 0x47, 0x0a, 0x0d, 0x43, 0x61,
	...
	0x63, 0x61, 0x6c, 0x22, 0x8b, 0x04, 0x0a, 0x0c, 0x43, 0x61, 0x72, 0x53, 0x6f, 0x75, 0x72, 0x63,
	...
	0x65, 0x22, 0xa9, 0x0e, 0x0a, 0x06, 0x43, 0x61, 0x72, 0x44, 0x74, 0x6f, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x64, 0x12, 0x15, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0xad, 0x02, 0x20, 0x01, 0x28,
	...
	0x21, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x9e, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c,
	0x2e, 0x63, 0x61, 0x72, 0x2e, 0x43, 0x61, 0x72, 0x54, 0x61, 0x67, 0x73, 0x52, 0x04, 0x74, 0x61,
	0x67, 0x73, 0x12, 0x2b, 0x0a, 0x11, 0x65, 0x78, 0x70, 0x5f, 0x73, 0x65, 0x6c, 0x6c, 0x69, 0x6e,
	...
	0x18, 0xc0, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x64, 0x65, 0x61, 0x6c, 0x65, 0x72, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x64, 0x65, 0x61, 0x6c, 0x65, 0x72, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0xc1, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e,
	0x64, 0x65, 0x61, 0x6c, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x30,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x85, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x69, 0x6e,
	0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x7b, 0x0a,
	...
	0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x22, 0x33, 0x0a, 0x09, 0x43, 0x61,
	...
	0x6c, 0x32, 0xbf, 0x03, 0x0a, 0x03, 0x43, 0x61, 0x72, 0x12, 0x26, 0x0a, 0x03, 0x41, 0x64, 0x64,
	...
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12,
	0x32, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65,
...
var file_car_car_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_car_car_proto_goTypes = []interface{}{
	...
	(*CarListParams)(nil),                    // 2: car.CarListParams
	(*CarSourceDto)(nil),                     // 3: car.CarSourceDto
	(*CarDto)(nil),                           // 4: car.CarDto
	(*UpdateCarDto)(nil),                     // 5: car.UpdateCarDto
	(*CarIdsDto)(nil),                        // 6: car.CarIdsDto
	(*CarDtoList)(nil),                       // 7: car.CarDtoList
	(*CarTags)(nil),                          // 8: car.CarTags
	(*CarResourceDto)(nil),                   // 9: car.CarResourceDto
	(*common.Page)(nil),                      // 10: common.Page
	(*reportProto.ReportDamagePointDto)(nil), // 11: report.ReportDamagePointDto
	(*common.IdDto)(nil),                     // 12: common.IdDto
	(*common.Response)(nil),                  // 13: common.Response
}
var file_car_car_proto_depIdxs = []int32{
	10, // 0: car.SourceParams.page:type_name -> common.Page
	10, // 1: car.CarListParams.page:type_name -> common.Page
	9,  // 2: car.CarDto.images_inner:type_name -> car.CarResourceDto
	9,  // 3: car.CarDto.images_outer:type_name -> car.CarResourceDto
	8,  // 4: car.CarDto.tags:type_name -> car.CarTags
	9,  // 5: car.CarDto.recondition_files:type_name -> car.CarResourceDto
	4,  // 6: car.UpdateCarDto.car:type_name -> car.CarDto
	11, // 7: car.UpdateCarDto.points:type_name -> report.ReportDamagePointDto
	4,  // 8: car.CarDtoList.CarDtoList:type_name -> car.CarDto
	4,  // 9: car.Car.Add:input_type -> car.CarDto
	6,  // 10: car.Car.Delete:input_type -> car.CarIdsDto
	5,  // 11: car.Car.Update:input_type -> car.UpdateCarDto
	6,  // 12: car.Car.Get:input_type -> car.CarIdsDto
	2,  // 13: car.Car.List:input_type -> car.CarListParams
	0,  // 14: car.Car.SourceList:input_type -> car.SourceParams
	1,  // 15: car.Car.AddFromSource:input_type -> car.AddFromSourceParams
	12, // 16: car.Car.LaunchCar:input_type -> common.IdDto
	12, // 17: car.Car.GetValidState:input_type -> common.IdDto
	13, // 18: car.Car.Add:output_type -> common.Response
	13, // 19: car.Car.Delete:output_type -> common.Response
	13, // 20: car.Car.Update:output_type -> common.Response
	13, // 21: car.Car.Get:output_type -> common.Response
	13, // 22: car.Car.List:output_type -> common.Response
	13, // 23: car.Car.SourceList:output_type -> common.Response
	13, // 24: car.Car.AddFromSource:output_type -> common.Response
	13, // 25: car.Car.LaunchCar:output_type -> common.Response
	13, // 26: car.Car.GetValidState:output_type -> common.Response
