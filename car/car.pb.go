...
type CarDto struct {
	...
	// 图片列表
	Images []*CarResourceDto `protobuf:"bytes,302,rep,name=images,proto3" json:"images,omitempty"`
	// spinCar链接
...
func (x *CarDto) GetImages() []*CarResourceDto {
	if x != nil {
		return x.Images
	}
	return nil
...
var file_car_car_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x98, 0x0d, 0x0a, 0x06, 0x43, 0x61, 0x72, 0x44, 0x74, 0x6f, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x09, 0x52, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x2c, 0x0a, 0x06, 0x69, 0x6d, 0x61, 0x67,
	0x65, 0x73, 0x18, 0xae, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x63, 0x61, 0x72, 0x2e,
	0x43, 0x61, 0x72, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x44, 0x74, 0x6f, 0x52, 0x06,
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x70, 0x69, 0x6e, 0x5f, 0x63,
	0x61, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0xaf, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x73,
	...
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x85, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x69,
	0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1c,
	0x0a, 0x09, 0x69, 0x73, 0x5f, 0x64, 0x65, 0x61, 0x6c, 0x65, 0x72, 0x18, 0xbf, 0x05, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x08, 0x69, 0x73, 0x44, 0x65, 0x61, 0x6c, 0x65, 0x72, 0x22, 0x7b, 0x0a, 0x0c,
	...
	0x09, 0x52, 0x06, 0x72, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x22, 0x33, 0x0a, 0x09, 0x43, 0x61, 0x72,
	...
	0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x22, 0x39,
	...
	0x32, 0xbf, 0x03, 0x0a, 0x03, 0x43, 0x61, 0x72, 0x12, 0x26, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12,
...
var file_car_car_proto_depIdxs = []int32{
	...
	9,  // 2: car.CarDto.images:type_name -> car.CarResourceDto
	8,  // 3: car.CarDto.tags:type_name -> car.CarTags
	9,  // 4: car.CarDto.recondition_files:type_name -> car.CarResourceDto
	4,  // 5: car.UpdateCarDto.car:type_name -> car.CarDto
	11, // 6: car.UpdateCarDto.points:type_name -> report.ReportDamagePointDto
	4,  // 7: car.CarDtoList.CarDtoList:type_name -> car.CarDto
	4,  // 8: car.Car.Add:input_type -> car.CarDto
	6,  // 9: car.Car.Delete:input_type -> car.CarIdsDto
	5,  // 10: car.Car.Update:input_type -> car.UpdateCarDto
	6,  // 11: car.Car.Get:input_type -> car.CarIdsDto
	2,  // 12: car.Car.List:input_type -> car.CarListParams
	0,  // 13: car.Car.SourceList:input_type -> car.SourceParams
	1,  // 14: car.Car.AddFromSource:input_type -> car.AddFromSourceParams
	12, // 15: car.Car.LaunchCar:input_type -> common.IdDto
	12, // 16: car.Car.GetValidState:input_type -> common.IdDto
	13, // 17: car.Car.Add:output_type -> common.Response
	13, // 18: car.Car.Delete:output_type -> common.Response
	13, // 19: car.Car.Update:output_type -> common.Response
	13, // 20: car.Car.Get:output_type -> common.Response
	13, // 21: car.Car.List:output_type -> common.Response
	13, // 22: car.Car.SourceList:output_type -> common.Response
	13, // 23: car.Car.AddFromSource:output_type -> common.Response
	13, // 24: car.Car.LaunchCar:output_type -> common.Response
	13, // 25: car.Car.GetValidState:output_type -> common.Response
