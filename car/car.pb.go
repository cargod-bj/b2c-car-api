...
var file_car_car_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x06, 0x6c, 0x65, 0x61, 0x64, 0x49, 0x64, 0x22, 0xd1, 0x04, 0x0a, 0x06, 0x43,
...
var file_car_car_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_car_car_proto_goTypes = []interface{}{
	(*SourceParams)(nil),    // 0: car.SourceParams
	(*CarDto)(nil),          // 1: car.CarDto
	(*CarIdDto)(nil),        // 2: car.CarIdDto
	(*common.Page)(nil),     // 3: common.Page
	(*common.Response)(nil), // 4: common.Response
}
var file_car_car_proto_depIdxs = []int32{
	3, // 0: car.SourceParams.page:type_name -> common.Page
	1, // 1: car.Car.Add:input_type -> car.CarDto
	2, // 2: car.Car.Delete:input_type -> car.CarIdDto
	1, // 3: car.Car.Update:input_type -> car.CarDto
	2, // 4: car.Car.Get:input_type -> car.CarIdDto
	3, // 5: car.Car.List:input_type -> common.Page
	0, // 6: car.Car.SourceList:input_type -> car.SourceParams
	4, // 7: car.Car.Add:output_type -> common.Response
	4, // 8: car.Car.Delete:output_type -> common.Response
	4, // 9: car.Car.Update:output_type -> common.Response
	4, // 10: car.Car.Get:output_type -> common.Response
	4, // 11: car.Car.List:output_type -> common.Response
	4, // 12: car.Car.SourceList:output_type -> common.Response
