...
type CarListCondition struct {
	...
	ModelId             uint64 `protobuf:"varint,3,opt,name=model_id,json=modelId,proto3" json:"model_id,omitempty"` //车系
	ModelName           string `protobuf:"bytes,4,opt,name=model_name,json=modelName,proto3" json:"model_name,omitempty"`
	BrandId             uint64 `protobuf:"varint,5,opt,name=brand_id,json=brandId,proto3" json:"brand_id,omitempty"` //品牌
	BrandName           string `protobuf:"bytes,6,opt,name=brand_name,json=brandName,proto3" json:"brand_name,omitempty"`
	Variant             string `protobuf:"bytes,7,opt,name=variant,proto3" json:"variant,omitempty"` //型号
	...
	Transmission        string `protobuf:"bytes,13,opt,name=transmission,proto3" json:"transmission,omitempty"`                //驾驶类型 手动，自动
	Engine              string `protobuf:"bytes,14,opt,name=engine,proto3" json:"engine,omitempty"`                            //排量
	Color               string `protobuf:"bytes,15,opt,name=color,proto3" json:"color,omitempty"`                              //颜色
	FuelType            string `protobuf:"bytes,16,opt,name=fuel_type,json=fuelType,proto3" json:"fuel_type,omitempty"`        //燃油
	SeatType            string `protobuf:"bytes,17,opt,name=seat_type,json=seatType,proto3" json:"seat_type,omitempty"`        //座位数
	ParkingId           uint64 `protobuf:"varint,18,opt,name=parking_id,json=parkingId,proto3" json:"parking_id,omitempty"`    //停车场
	StoreId             uint64 `protobuf:"varint,20,opt,name=store_id,json=storeId,proto3" json:"store_id,omitempty"`          //店铺
	Source              string `protobuf:"bytes,22,opt,name=source,proto3" json:"source,omitempty"`                            //来源
	Location            string `protobuf:"bytes,23,opt,name=location,proto3" json:"location,omitempty"`                        //城市
	LocationId          uint64 `protobuf:"varint,27,opt,name=location_id,json=locationId,proto3" json:"location_id,omitempty"` //地址id
	Dealer              string `protobuf:"bytes,24,opt,name=dealer,proto3" json:"dealer,omitempty"`                            //经销商
	//carlist排序条件
...
func (x *CarListCondition) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
func (x *CarListCondition) GetFuelType() string {
	if x != nil {
		return x.FuelType
	}
	return ""
...
func (x *CarListCondition) GetSeatType() string {
	if x != nil {
		return x.SeatType
	}
	return ""
...
func (x *CarListCondition) GetDealer() string {
	if x != nil {
		return x.Dealer
	}
	return ""
...
var file_carList_carList_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe7, 0x05, 0x0a, 0x0a, 0x43, 0x61, 0x72, 0x4c,
	...
	0x71, 0x12, 0x1e, 0x0a, 0x0a, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	...
	0x65, 0x22, 0xa7, 0x06, 0x0a, 0x10, 0x43, 0x61, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6e,
	...
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07,
	...
	,
	...
	0x1b, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49,
	0x64, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x65, 0x61, 0x6c, 0x65, 0x72, 0x18, 0x18, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x64, 0x65, 0x61, 0x6c, 0x65, 0x72, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x6f, 0x72,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x32, 0xed, 0x01, 0x0a, 0x07,
...
var file_carList_carList_proto_depIdxs = []int32{
	...
	4, // 5: car.CarList.Add:output_type -> common.Response
	4, // 6: car.CarList.Delete:output_type -> common.Response
	4, // 7: car.CarList.Update:output_type -> common.Response
	4, // 8: car.CarList.Get:output_type -> common.Response
	4, // 9: car.CarList.List:output_type -> common.Response
