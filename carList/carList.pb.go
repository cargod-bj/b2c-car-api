...
type CarReport struct {
	...
	Enums map[uint64]*CarDetailReport `protobuf:"bytes,1,rep,name=enums,proto3" json:"enums,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *CarReport) GetEnums() map[uint64]*CarDetailReport {
	if x != nil {
		return x.Enums
	}
	return nil
...
var file_carList_carList_proto_rawDesc = []byte{
	...
	0x72, 0x49, 0x64, 0x73, 0x22, 0x8c, 0x01, 0x0a, 0x09, 0x43, 0x61, 0x72, 0x52, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x12, 0x2f, 0x0a, 0x05, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x19, 0x2e, 0x63, 0x61, 0x72, 0x2e, 0x43, 0x61, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x72,
	0x74, 0x2e, 0x45, 0x6e, 0x75, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x65, 0x6e,
	0x75, 0x6d, 0x73, 0x1a, 0x4e, 0x0a, 0x0a, 0x45, 0x6e, 0x75, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72,
...
var file_carList_carList_proto_goTypes = []interface{}{
	...
	nil,                                         // 14: car.CarReport.EnumsEntry
...
var file_carList_carList_proto_depIdxs = []int32{
	...
	14, // 7: car.CarReport.enums:type_name -> car.CarReport.EnumsEntry
	15, // 8: car.CarDetailReport.report:type_name -> report.ReportDamageCategoryDto
	13, // 9: car.CarReport.EnumsEntry.value:type_name -> car.CarDetailReport
