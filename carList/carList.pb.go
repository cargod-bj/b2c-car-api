...
type CarListDto struct {
	...
	RegistrationDate     string `protobuf:"bytes,721,opt,name=registration_date,json=registrationDate,proto3" json:"registration_date,omitempty"`
...
func (x *CarListDto) GetRegistrationDate() string {
	if x != nil {
...
var file_carList_carList_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x18, 0xd1, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x72, 0x65, 0x67,
	...
	0x72, 0x74, 0x32, 0x8d, 0x03, 0x0a, 0x07, 0x43, 0x61, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2a,
