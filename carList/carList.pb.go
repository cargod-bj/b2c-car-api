...
type CarListDto struct {
	...
	CardDiscountWordsColor           string   `protobuf:"bytes,843,opt,name=cardDiscountWordsColor,proto3" json:"cardDiscountWordsColor,omitempty"`                     //卡片折扣文字颜色
	CardDiscountTag                  string   `protobuf:"bytes,844,opt,name=cardDiscountTag,proto3" json:"cardDiscountTag,omitempty"`                                   //卡片图片
	CardDiscountWordsBackgroundColor string   `protobuf:"bytes,845,opt,name=cardDiscountWordsBackgroundColor,proto3" json:"cardDiscountWordsBackgroundColor,omitempty"` //卡片折扣文字背景颜色
}
