...
type EnumsDto struct {
	...
	Enums map[string]*KVMap `protobuf:"bytes,1,rep,name=enums,proto3" json:"enums" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type KVMap struct {
	...
	Kvs map[string]uint32 `protobuf:"bytes,1,rep,name=kvs,proto3" json:"kvs" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
type CarEnumConfigDTO struct {
	...
	Value        uint32 `protobuf:"varint,5,opt,name=Value,proto3" json:"Value"`
	LangEn       string `protobuf:"bytes,6,opt,name=LangEn,proto3" json:"LangEn"`
	LangMs       string `protobuf:"bytes,7,opt,name=LangMs,proto3" json:"LangMs"`
	LangId       string `protobuf:"bytes,8,opt,name=LangId,proto3" json:"LangId"`
	LangTh       string `protobuf:"bytes,9,opt,name=LangTh,proto3" json:"LangTh"`
	LangHi       string `protobuf:"bytes,10,opt,name=LangHi,proto3" json:"LangHi"`
	LangZh       string `protobuf:"bytes,11,opt,name=LangZh,proto3" json:"LangZh"`
	Order        uint32 `protobuf:"varint,12,opt,name=Order,proto3" json:"Order"`
	Status       uint32 `protobuf:"varint,13,opt,name=Status,proto3" json:"Status"`
	CreateTime   uint64 `protobuf:"varint,14,opt,name=createTime,proto3" json:"createTime"`
	UpdateTime   uint64 `protobuf:"varint,15,opt,name=updateTime,proto3" json:"updateTime"`
	UpdateUserId uint64 `protobuf:"varint,16,opt,name=updateUserId,proto3" json:"updateUserId"`
}
