...
func (x *CarCampaignDto) Reset() {
	*x = CarCampaignDto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_carCampaign_carCompaign_proto_msgTypes[0]
...
func (*CarCampaignDto) Descriptor() ([]byte, []int) {
	return file_carCampaign_carCompaign_proto_rawDescGZIP(), []int{0}
}
...
var File_carCampaign_carCompaign_proto protoreflect.FileDescriptor

var file_carCampaign_carCompaign_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x63, 0x61, 0x72, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x2f, 0x63, 0x61,
	0x72, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x0b, 0x63, 0x61, 0x72, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x1a, 0x39, 0x67, 0x69,
	...
	0x72, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x12, 0x3d, 0x0a, 0x18, 0x47, 0x65, 0x74,
	...
	0x43, 0x6f, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_carCampaign_carCompaign_proto_rawDescOnce sync.Once
	file_carCampaign_carCompaign_proto_rawDescData = file_carCampaign_carCompaign_proto_rawDesc
)

func file_carCampaign_carCompaign_proto_rawDescGZIP() []byte {
	file_carCampaign_carCompaign_proto_rawDescOnce.Do(func() {
		file_carCampaign_carCompaign_proto_rawDescData = protoimpl.X.CompressGZIP(file_carCampaign_carCompaign_proto_rawDescData)
	})
	return file_carCampaign_carCompaign_proto_rawDescData
}

var file_carCampaign_carCompaign_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_carCampaign_carCompaign_proto_goTypes = []interface{}{
	(*CarCampaignDto)(nil),  // 0: carCompaign.CarCampaignDto
	(*common.IdDto)(nil),    // 1: common.IdDto
	(*common.Response)(nil), // 2: common.Response
}
var file_carCampaign_carCompaign_proto_depIdxs = []int32{
	1, // 0: carCompaign.CarCompaign.GetCurrentActiveCampaign:input_type -> common.IdDto
	2, // 1: carCompaign.CarCompaign.GetCurrentActiveCampaign:output_type -> common.Response
...
func init() { file_carCampaign_carCompaign_proto_init() }
func file_carCampaign_carCompaign_proto_init() {
	if File_carCampaign_carCompaign_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_carCampaign_carCompaign_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_carCampaign_carCompaign_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_carCampaign_carCompaign_proto_goTypes,
		DependencyIndexes: file_carCampaign_carCompaign_proto_depIdxs,
		MessageInfos:      file_carCampaign_carCompaign_proto_msgTypes,
	}.Build()
	File_carCampaign_carCompaign_proto = out.File
	file_carCampaign_carCompaign_proto_rawDesc = nil
	file_carCampaign_carCompaign_proto_goTypes = nil
	file_carCampaign_carCompaign_proto_depIdxs = nil
}
